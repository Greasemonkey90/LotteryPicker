...
public class GameNumbers extends ArrayList<Integer> {
    ...
    public ArrayList<Integer> setPick3() {
    ...
    public ArrayList<Integer> setPick4() {
        ArrayList<Integer> gameList = new ArrayList<>();
    ...
    public ArrayList<Integer> setCash5() {
        ArrayList<Integer> gameList = new ArrayList<>();
    ...
    public ArrayList<Integer> setPowerBall() {
        ArrayList<Integer> gameList = new ArrayList<>();
    ...
    public ArrayList<Integer> setMegaMillion() {
        ArrayList<Integer> gameList = new ArrayList<>();
        for (int count = 1; count <= 6; count++) {
            if (count == 6) {
                Random lastPick = new Random();
    ...
    public ArrayList<Integer> setCash4Life() {
        ArrayList<Integer> gameList = new ArrayList<>();
        for (int count = 1; count <= 6; count++) {
            if (count == 6) {
                Random lastPick = new Random();
    ...
    public ArrayList<Integer> setBankAmillion() {
        ArrayList<Integer> gameList = new ArrayList<>();
        for (int count = 1; count <= 6; count++) {
            Random randomNum = new Random();
